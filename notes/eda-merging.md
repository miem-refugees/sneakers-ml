...
- Самый показательный это UMAP. В нём отчетливо видны кластеры.[img]
- Визулизовав их стало ясно, что они соответствуют ракурсам изображения. Например, в одном кластере были только изображения подошв. [img]
